...
{
  var win= window.open(`https://wa.me/${whatsapp}?text=Hola%20mi%20nombre%20es%20*${nombreyapellido}*
,%20quisiera%20una%20torta%20para%20*${cantidadp}* personas, Los tres ingredientes a eleccion son:%20*${ingredientes}*.`,'_blank');
}else if(toppingid=="" && cante==0) //topping == cantidad extra == 0
{
  var win= window.open(`https://wa.me/${whatsapp}?text=Hola%20mi%20nombre%20es%20*${nombreyapellido}*
,%20quisiera%20una%20torta%20para%20${cantidadp} personas, Los tres ingredientes a eleccion son:%20${ingredientes},%20
...
var win= window.open(`https://wa.me/${whatsapp}?text=Hola%20mi%20nombre%20es%20*${nombreyapellido}*
,%20quisiera%20una%20torta%20para%20*${cantidadp}* personas, Los tres ingredientes a eleccion son:%20*${ingredientes}*
,%20los ingredientes extras son:%20*${extras}*%20Topping:%20*${toppingid}*, Mi consulta es:%20*${consulta}*`,'_blank');
}
...
function Ver()
 {
   swal("¿Qué son los Topping?","Son extras que funcionan como acompañamientos para la torta con un precio adicional.");
 }